...
## 开始菜单功能模块
  - 电源  (左边开始菜单页面，左下角倒数第一个按钮)
  - 设置  (左边开始菜单页面，左下角倒数第二个按钮)
  - 文件管理 (左边开始菜单页面，左下角倒数第三个按钮)
  - 常用软件 (左边开始菜单页面，左上app应用)
  - 搜索框   (左边开始菜单页面，右边最上面的search)
  - 升序降序按钮  (左边开始菜单页面，右边最上面search右边朝上箭头)
  - 排序按钮      (左边开始菜单页面，顶部最右边按钮)
  - 系统应用    (左边开始菜单页面，搜索框下面的app)
